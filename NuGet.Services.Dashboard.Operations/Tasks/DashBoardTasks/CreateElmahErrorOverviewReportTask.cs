...
namespace NuGetGallery.Operations
{
    ...
    { 
        ...
        {        
            ...
            ReportHelpers.AppendDatatoBlob(StorageAccount, "ErrorRate" + string.Format("{0:MMdd}", DateTime.Now) + ".json", new Tuple<string, string>(String.Format("{0:HH:mm}", DateTime.UtcNow.AddHours(-1).ToLocalTime()), count.ToString()), 50, ContainerName);            
        }
